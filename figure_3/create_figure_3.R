...
par(mfrow=c(2,1),bty="l",mar=c(1.5,6,2,1.5),lwd=2,cex.axis=1.25,cex.lab=1.5,oma=c(4,0,0,0))


plot(1,1,type="n",xlab="time (generations)",ylab="range border position",xlim=c(0,5000),ylim=c(75,250))
