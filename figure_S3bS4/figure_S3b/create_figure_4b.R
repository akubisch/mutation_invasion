...
plot(1,1,type="n",xlim=range(ts),ylim=c(0.0,0.3),xlab="",ylab=expression(paste("mutation rate of ",tau[opt]," (*",10^-4,")",sep="")),yaxt="n",xaxt="n")
axis(side=1,at=c(0,2500,5000))
...
dev.copy2eps(file="figure_S3b.eps",title="Cobben & Kubisch - Figure S3b")
